	...
	Meteor.methods({
		...
		seedDatabase : function(){
		    ...
		    Cards.insert({
		        ...
		        visible_after: 0,
		        story_file_name: "pfizer_clarikote.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 0,
		        story_file_name: "hp_offlinebox.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 0,
		        story_file_name: "ibm_pfizer_partner.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 6,
		        story_file_name: "rupesh_oil.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 12,
		        story_file_name: "dannon_asad.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 18,
		        story_file_name: "kanye_chili.txt",
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 24,
		        story_file_name: "airport_testing.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 30,
		        story_file_name: "bank1_no_asad.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 36,
		        story_file_name: "ibm_resurgence.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        visible_after: 42,
		        story_file_name: "kanye_drone.txt"
		    });
		        ...
		        visible_after: 48,
		        story_file_name: "kanye_jetpack.txt"
		    });
		    ...
		    Cards.insert({
		        ...
		        lightbox_url: "www.kanesic.com (article about strange, inconvenient wearable Kanye invents)",
		        visible_after: 54,
		        story_file_name: "indian_asad_iit.txt"
		    });
		   	...
		   	Cards.insert({
		        ...
		        visible_after: 60,
		        story_file_name: "ibm_lose_weight.txt"
		    });
		   	...
		   	Cards.insert({
		        ...
		        lightbox_url: "Rulers.com",
		        visible_after: 66,
		        story_file_name: "indian_youth_protest.txt"
		    });
		}
	});
});
